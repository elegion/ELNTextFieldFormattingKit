...
@interface ELNTextFieldFormatter ()

@property (nonatomic, strong) id<ELNTextMask> mask;
@property (nonatomic, strong) UITextField *textField;

@end

@implementation ELNTextFieldFormatter
...
- (instancetype)initWithTextField:(UITextField *)textField mask:(id<ELNTextMask>)mask {
    self = [super init];
    if (self) {
        self.mask = mask;
